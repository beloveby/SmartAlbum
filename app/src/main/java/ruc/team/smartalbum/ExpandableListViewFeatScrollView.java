 ...
 */
public class ExpandableListViewFeatScrollView extends ExpandableListView implements View.OnTouchListener,
        AbsListView.OnScrollListener {
    private int listViewTouchAction;
    private static final int MAXIMUM_LIST_ITEMS_VIEWABLE = 99;

    public ExpandableListViewFeatScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
